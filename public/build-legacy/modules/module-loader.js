...
(function initLmbModuleLoader(global) {
  ...
  function loadScriptOnce(url) {
    ...
    return new Promise(function (resolve, reject) {
      var existing = document.querySelector('script[data-lmb-module-src="' + url + '"]');
      if (existing) {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          ...
          case 1:
            ...
            return _context2.a(2, pending.get(key));
          case 2:
            task = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
              var scriptUrl, modules, mod, _t;
              return _regenerator().w(function (_context) {
                while (1) switch (_context.p = _context.n) {
                  case 0:
                    ...
                    _context.p = 1;
                    _context.n = 2;
                    return global.lmbLazyModules.ensure(key);
                  case 2:
                    _context.n = 4;
                    break;
                  case 3:
                    ...
                    _t = _context.v;
                  case 4:
                    scriptUrl = moduleScripts[key];
                    if (!scriptUrl) {
                      _context.n = 5;
                      break;
                    }
                    _context.n = 5;
                    return loadScriptOnce(scriptUrl);
                  case 5:
                    modules = global.LMBModules || {};
                    mod = modules[key];
  ...
  function preloadMobileDefaults() {
    ...
    var defaults = isMobile ? ['game-board', 'countdown', 'wallet', 'chat', 'notifications'] : ['game-board', 'countdown', 'wallet', 'chat', 'notifications'];
