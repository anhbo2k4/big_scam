  ...
  (function () {
    ...
    try {
      var opts = Object.defineProperty({}, 'once', {
        get: function () { supportsOnce = true; return true; }
      });
    ...
    if (!supportsOnce) {
      ...
      EventTarget.prototype.addEventListener = function (type, listener, optionsOrCapture) {
        if (optionsOrCapture && typeof optionsOrCapture === 'object' && optionsOrCapture.once) {
          var self = this;
          var fired = false;
          var wrappedFn = function (e) {
            if (fired) return;
            fired = true;
            _origRemove.call(self, type, wrappedFn, optionsOrCapture);
          ...
          return _origAdd.call(this, type, wrappedFn, optionsOrCapture);
        }
  ...
  if (!Element.prototype.animate) {
    Element.prototype.animate = function (keyframes, options) {
      ...
      var timer = setTimeout(function () {
        for (var prop in lastFrame) {
          if (lastFrame.hasOwnProperty(prop)) {
            try { el.style[prop] = lastFrame[prop]; } catch (e) {}
          }
        }
      ...
      var result = {
        ...
        finished: { then: function (cb) { setTimeout(cb, duration); } }
      };
      return result;
    };
  }
    ...
    if (Element.prototype.scrollIntoView) {
      ...
      Element.prototype.scrollIntoView = function (optsOrBool) {
        try {
          ...
          origScrollIntoView.call(this, typeof optsOrBool === 'object' ? true : optsOrBool);
        }
      };
    }
  })();
